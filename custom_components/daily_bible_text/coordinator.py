...
class BibleTextCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self) -> dict:
        ...
        weekday_lists = {"de": WEEKDAYS_DE, "en": WEEKDAYS_EN, "es": WEEKDAYS_ES}
        weekday_list = weekday_lists.get(self._detected_language, WEEKDAYS_EN)
        today_weekday = weekday_list[now.weekday()].capitalize()
