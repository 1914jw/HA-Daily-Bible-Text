...
class BibleScriptureSensor(_BibleBase):
    ...
    def native_value(self) -> str | None:
        ...
        if not verse:
            return None
        return strip_verse_reference(verse)
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            ATTR_DAY: self._data.get("weekday"),
...
class BibleCommentarySensor(_BibleBase):
    """Citation ('quelle') as state, e.g. 'w24.06 21 Abs. 8'; full text in commentary_text."""
    ...
    @property
    def native_value(self) -> str | None:
        return self._data.get("citation") or None
    ...
    def extra_state_attributes(self) -> dict:
        return {
            ...
            ATTR_SOURCE_EPUB: self._data.get("source_epub"),
            ATTR_ENTRIES_COUNT: self._data.get("entries_count"),
            "commentary_text": self._data.get("commentary", ""),
        }
